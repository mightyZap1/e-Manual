...
>Error for each Force value is +/- 15%.

>[!warning] Caution
>Stall force is for reference only. To prevent product damage, use within rated load in actual application.
...
![goalsopeedVSspeed](./img/00_goalspeedVSspeed.png)
>[!note] Note
...
>[!warning] Caution
>Error for each Goal Current value's Stall Force is +/- 15%.
