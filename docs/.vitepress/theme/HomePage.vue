    ...
    <section class="hero-section">
            <div class="container">
                ...
                <div class="search-wrapper" ref="searchWrapperRef">
                    ...
                    <input 
                        type="text" 
                        placeholder="제품명, 모델명, 키워드로 검색... (예: 17Lf, Modbus)" 
                        class="search-input" 
                        autocomplete="off"
                        v-model="searchQuery" 
        ...
        <section class="feature-section" style="background-color: var(--color-gray-50);">
            <div class="container">
                <div class="section-header">
                    <h2>제품 시리즈별 문서 찾기</h2>
                    <p>찾으시는 제품 시리즈를 선택하여 관련 문서를 확인하세요.</p>
                </div>
                <div class="grid-container grid-container-md-2 grid-container-lg-3">
                    <a href="#" class="product-card">
                        <div class="image-wrapper"><img src="https://placehold.co/400x300/e2e8f0/334155?text=Mini+17Lf" alt="Mini 17Lf 시리즈 이미지"></div>
                        <div class="content">
                            <h3>Mini 17Lf 시리즈</h3>
                            <p>소형 정밀 제어를 위한 컴팩트 리니어 액추에이터</p>
                        </div>
                    </a>
                    <a href="#" class="product-card">
                        <div class="image-wrapper"><img src="https://placehold.co/400x300/e2e8f0/334155?text=Mini+12Lf" alt="Mini 12Lf 시리즈 이미지"></div>
                        <div class="content">
                            <h3>Mini 12Lf 시리즈</h3>
                            <p>초소형 사이즈에 강력한 힘을 갖춘 리니어 서보</p>
                        </div>
                    </a>
                    <a href="#" class="product-card">
                        <div class="image-wrapper"><img src="https://placehold.co/400x300/e2e8f0/334155?text=D7D12L12" alt="D7D12L12 시리즈 이미지"></div>
                        <div class="content">
                            <h3>D7D12L12 시리즈</h3>
                            <p>내구성과 신뢰성이 강화된 산업용 리니어 액추에이터</p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <section class="feature-section" style="background-color: white;">
            <div class="container content-with-sidebar">
                ...
                <div class="main-content-col">
                    <div class="section-header">
                        <h2>기술 지원 리소스</h2>
                        <p>문제 해결 및 개발에 필요한 다양한 정보를 확인하세요.</p>
                    </div>
                ...
                <aside class="updates-sidebar-col">
                    ...
                    <div class="updates-list">
                        <a href="#" class="update-item">
                            <p class="date">2025년 7월 31일</p>
                            <h4>mightyZAP 17Lf 사용자 매뉴얼 (v2.1) 업데이트</h4>
                            <p>Modbus RTU 통신 관련 내용이 보강되었습니다.</p>
                        </a>
                        <a href="#" class="update-item">
                            <p class="date">2025년 7월 28일</p>
                            <h4>Total Manager 소프트웨어 가이드 추가</h4>
                            <p>새로운 기능인 모션 티칭 사용법이 추가되었습니다.</p>
                        </a>
                    </div>
                </aside>
            </div>
